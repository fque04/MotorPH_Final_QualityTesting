...
public class MotorPH_Contents extends ErrorTest implements SetLabel {
    // Instance variables representing different aspects of employee data and calculations
    ...
    // A log-in display box that will direct to the MotorPH portal
    ...
    // A log-out display box that will exit the program
    public void logout() {
    ...
    // Method that displays the information needed to view the payroll
    public void displayInformation() throws IOException {
        ...
        // Loop to validate employee number input
        ...
        // Loop to validate start date input
        ...
        // Loop to validate end date input
        ...
        // Printing employee information related to payroll
